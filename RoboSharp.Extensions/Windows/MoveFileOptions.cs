...
{
    /// <summary>
    /// The Options that can be used with MoveFileWithProgressA -- <see cref="FileFunctions.MoveFile(string, string, CopyProgressCallback, IntPtr, MoveFileOptions)"/>
    /// </summary>
